...
import com.scanqr.qrscanner.qrgenerator.databinding.ItemBatchBinding
...
class ScanBatchAdapter(
...
) : RecyclerView.Adapter<ScanBatchAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemBatchBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    private fun setDataType(binding: ItemBatchBinding, cardColor: String, cardItem: Int, model: HistoryModel, typeShow: String) {
