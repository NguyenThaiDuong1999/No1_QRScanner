...
public class BitmapUtilsNo1 {
    private static final String TAG = "BitmapUtils";

    /** Converts NV21 format byte buffer to bitmap. */
    @Nullable
    public static Bitmap getBitmap(ByteBuffer data, FrameMetaDataNo1 metadata) {
        data.rewind();
    ...
    public static Bitmap getBitmap(ImageProxy image) {
        FrameMetaDataNo1 frameMetaDataNo1 =
                new FrameMetaDataNo1.Builder()
        ...
        return getBitmap(nv21Buffer, frameMetaDataNo1);
    }
