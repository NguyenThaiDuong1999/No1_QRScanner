...
import com.scanqr.qrscanner.qrgenerator.databinding.ItemContentQrBinding

class MultipleContentAdapter(
    private val list: MutableList<String>
) : RecyclerView.Adapter<MultipleContentAdapter.ViewHolder>() {

    inner class ViewHolder(private val binding: ItemContentQrBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(str: String) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemContentQrBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
