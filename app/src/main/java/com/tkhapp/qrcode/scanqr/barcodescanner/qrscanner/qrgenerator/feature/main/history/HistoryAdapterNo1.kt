...
import com.tkhapp.qrcode.scanqr.barcodescanner.qrscanner.qrgenerator.databinding.ItemHistoryNo1Binding
import com.tkhapp.qrcode.scanqr.barcodescanner.qrscanner.qrgenerator.databinding.PopupMoreActionHistoryNo1Binding
...
class HistoryAdapterNo1(
...
) : RecyclerView.Adapter<HistoryAdapterNo1.HistoryViewHolder>() {

    private var isOnAction = false

    inner class HistoryViewHolder(private val binding: ItemHistoryNo1Binding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: HistoryModel) {
            ...
            binding.icMore.tap {
                val binding = PopupMoreActionHistoryNo1Binding.inflate(LayoutInflater.from(itemView.context))
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HistoryAdapterNo1.HistoryViewHolder {
        return HistoryViewHolder(ItemHistoryNo1Binding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: HistoryAdapterNo1.HistoryViewHolder, position: Int) {
    ...
    private fun setDataType(binding: ItemHistoryNo1Binding, cardColor: String, cardItem: Int, model: HistoryModel, typeShow: String) {
