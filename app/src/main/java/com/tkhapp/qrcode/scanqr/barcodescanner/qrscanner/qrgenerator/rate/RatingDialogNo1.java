package com.tkhapp.qrcode.scanqr.barcodescanner.qrscanner.qrgenerator.rate;
...
public class RatingDialogNo1 extends Dialog {
    ...
    public RatingDialogNo1(Context context2) {
        super(context2, R.style.CustomAlertDialog);
        this.context = context2;
        setContentView(R.layout.dialog_rating_app_no1);
